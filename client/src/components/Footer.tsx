    ...
    <footer className="bg-secondary-green p-8">
      <div className="mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-primary-green font-semibold mb-4">Quick Links</h3>
            <ul className="text-gray-700 text-sm space-y-2">
              <li><a href="/" className="hover:text-primary-green">Home</a></li>
              <li><a href="/events" className="hover:text-primary-green">Events</a></li>
              <li><a href="/merch" className="hover:text-primary-green">Merch</a></li>
              <li><a href="/" className="hover:text-primary-green">About</a></li>
            </ul>
          </div>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-primary-green font-semibold mb-4">Contact Us</h3>
            <ul className="text-gray-700 text-sm space-y-2">
              <li>IIIT Kottayam</li>
          ...
          {/* Social Media Links */}
          <div className="flex justify-center gap-4 text-green-700 mb-4">
