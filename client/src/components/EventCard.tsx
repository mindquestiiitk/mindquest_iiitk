...
export function EventCard({ id, title, image, brief }: EventCardProps) {
  ...
  return (
    <div
      className="relative overflow-hidden font-acme group transform transition-all duration-300 hover:scale-105  bg-eventcard-background border-card-overlay-background rounded-lg"
    ...
    >
      <div className="p-0">
        ...
        >
          <h3 className="text-white text-2xl font-bold mb-2 transform transition-all duration-300">{title}</h3>
          <p className="text-white text-base font-light mb-4 text-center transform transition-all duration-300">{brief}</p>
